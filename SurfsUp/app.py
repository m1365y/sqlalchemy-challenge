...
def start_date(start):
    ...
    if start <= '2017-08-23':
        ...
        return jsonify("Error 404: start date past time horizon, please enter a date before 2017-08-23'")
...
def start_end(start, end):
    ...
    if (start <= '2017-08-23') and (end >='2010-01-01') :
        ...
        return jsonify("Error 404: start and end date not within time horzion, please enter a start and end date between 2010-01-01 : 2017-08-23")
